...
다른점, 장점 : 위급상황 시에 휴대폰의 첫 화면인 잠금화면을 거쳐 위젯을 통해 들어가야 하는 

기존 제품보다 훨씬 빠르게 어플에 접근하여 긴급상황임을 주변인에게 알릴 수 있다. 
또한 두 제품 모두 GPS를 기반으로 하는 시스템이기 때문에 작동이 잘 되지 않을 수 있는 위험

이 있는데 우리 팀에서 제시한 제품은 gps의 영향을 전혀 받지 않고 어디서든 보낼 수 있다. 
